...
public class ChunkProviderChocolateTest implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    private MapGenBase caveGenerator = new MapGenChocolateCaves();
    ...
    private MapGenBase ravineGenerator = new MapGenChocolateRavine();
    ...
    public ChunkProviderChocolateTest(World par1World, long par2, boolean par4)
    {
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    p_147424_3_[j3 += short1] = BlockRegistry.chocoStone;
                                }
                                else if (k2 * 8 + l2 < b0)
                                {
                                    p_147424_3_[j3 += short1] = LiquidRegistry.chocolateMilkBlock;
                                }
                                else
                                {
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
            ...
            && TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, LAKE))
        {
            ...
            (new WorldGenLakes(LiquidRegistry.lightChocolateMilkBlock)).generate(this.worldObj, this.rand, k1, l1, i2);
        }
        if (biomegenbase != BiomeGenBase.desert && biomegenbase != BiomeGenBase.desertHills && !flag && this.rand.nextInt(4) == 0
                && TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, LAKE))
            {
                ...
                l1 = this.rand.nextInt(256);
                i2 = l + this.rand.nextInt(16) + 8;
                (new WorldGenLakes(LiquidRegistry.whiteChocolateMilkBlock)).generate(this.worldObj, this.rand, k1, l1, i2);
            }
        ...
        if (TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, LAVA) && !flag && this.rand.nextInt(8) == 0)
        {
            ...
            {
                (new WorldGenLakes(LiquidRegistry.chocolateMilkBlock)).generate(this.worldObj, this.rand, k1, l1, i2);
            }
        }
        if (TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, LAVA) && !flag && this.rand.nextInt(8) == 0)
        {
            ...
            if (l1 < 63 || this.rand.nextInt(10) == 0)
            {
                (new WorldGenLakes(LiquidRegistry.darkChocolateMilkBlock)).generate(this.worldObj, this.rand, k1, l1, i2);
            }
        }
        if (TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, LAVA) && !flag && this.rand.nextInt(8) == 0)
        {
            ...
            if (l1 < 63 || this.rand.nextInt(10) == 0)
            {
                (new WorldGenLakes(LiquidRegistry.moltenCaramelBlock)).generate(this.worldObj, this.rand, k1, l1, i2);
            }
        }
