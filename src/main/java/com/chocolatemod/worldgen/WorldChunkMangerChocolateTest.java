...
public class WorldChunkMangerChocolateTest extends WorldChunkManager
{
...
protected WorldChunkMangerChocolateTest()
{
...
public WorldChunkMangerChocolateTest(long seed, WorldType worldtype)
{
this();
...
public WorldChunkMangerChocolateTest(World world)
{
...
if (biome == null)
{
return BiomeGenChocolateBase.chocolatePlains;
}
...
par1ArrayOfBiomeGenBase[i1] = BiomeGenChocolateBase.chocolatePlains;
}
}
