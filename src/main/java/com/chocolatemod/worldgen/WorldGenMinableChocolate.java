...
public class WorldGenMinableChocolate extends WorldGenerator
{
    ...
    public WorldGenMinableChocolate(Block p_i45459_1_, int p_i45459_2_, int p_i45460_3_)
    {
        this(p_i45459_1_, p_i45459_2_, p_i45460_3_, Blocks.stone);
    }


	public WorldGenMinableChocolate(Block p_i45460_1_, int p_i45460_2_, int p_i45460_3_, Block p_i45460_4_)
    {
        this.field_150519_a = p_i45460_1_;
        this.numberOfBlocks = p_i45460_2_;
        this.mineableBlockMeta = p_i45460_3_;
        this.field_150518_c = p_i45460_4_;
      
    }

    public WorldGenMinableChocolate(Block block, int number, Block target)
    {
        this(block, number, number, target);
