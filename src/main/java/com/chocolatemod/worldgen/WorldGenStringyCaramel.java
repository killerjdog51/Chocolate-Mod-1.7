...
public class WorldGenStringyCaramel extends WorldGenerator
{
        ...
        for (int i1 = p_76484_5_; p_76484_4_ < 128; ++p_76484_4_)
        {
            if (p_76484_1_.isAirBlock(p_76484_3_, p_76484_4_, p_76484_5_))
            {
                for (int j1 = 2; j1 <= 5; ++j1)
                {
                    ...
                    {
                        p_76484_1_.setBlock(p_76484_3_, p_76484_4_, p_76484_5_, PlantRegistry.stringyCaramel, 1 << Direction.facingToDirection[Facing.oppositeSide[j1]], 2);
                        break;
                    }
                }
            }
