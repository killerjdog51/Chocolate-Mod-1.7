...
public class WorldGenChocolateTree extends WorldGenAbstractTree {
	private boolean field_150531_a;
	private static final String __OBFID = "CL_00000401";

	public WorldGenChocolateTree(boolean p_i45449_1_, boolean p_i45449_2_) {
		super(p_i45449_1_);
				...
				if (isSoil && par4 < 256 - l - 1) {
							...
							for (int i2 = par5 - k1; i2 <= par5 + k1; ++i2) {
								...
								if (Math.abs(l1) != k1 || Math.abs(j2) != k1 || par2Random.nextInt(2) != 0 && j1 != 0) {
									...
									if (block1.isAir(par1World, l2, k2, i2) || block1.isLeaves(par1World, l2, k2, i2)) {
										this.setBlockAndNotifyAdequately(par1World, l2, k2, i2, PlantRegistry.cocoaleaf, 0);
									}
								}
							}
						}
					...
					for (k2 = 0; k2 < l; ++k2) {
						...
						if (block3.isAir(par1World, par3, par4 + k2, par5) || block3.isLeaves(par1World, par3, par4 + k2, par5)) {
							this.setBlockAndNotifyAdequately(par1World, par3, par4 + k2, par5, BlockRegistry.chocolatepiller, 0);
						}
					}
