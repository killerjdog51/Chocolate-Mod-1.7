...
public class WorldGenDarkChocolateTree extends WorldGenAbstractTree
{
    private static final String __OBFID = "CL_00000435";

    public WorldGenDarkChocolateTree(boolean par1)
    {
        super(par1);
    }
            ...
            else
            {
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                    ...
                    for (i4 = 0; i4 <= j1; ++i4)
                    {
                        ...
                        for (int l2 = par3 - l3; l2 <= par3 + l3; ++l2)
                        {
                            ...
                            for (int j3 = par5 - l3; j3 <= par5 + l3; ++j3)
                            {
                                ...
                                {
                                    this.setBlockAndNotifyAdequately(par1World, l2, k2, j3, PlantRegistry.cocoaleaf, 1);
                                }
                            }
                        }
                    ...
                    for (k2 = 0; k2 < l - i4; ++k2)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(par1World, par3, par4 + k2, par5, BlockRegistry.chocolatepiller, 1);
                        }
                    }
