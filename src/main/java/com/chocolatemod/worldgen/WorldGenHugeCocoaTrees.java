...
public abstract class WorldGenHugeCocoaTrees extends WorldGenAbstractTree
{
    ...
    public WorldGenHugeCocoaTrees(boolean p_i45458_1_, int p_i45458_2_, int p_i45458_3_, int p_i45458_4_, int p_i45458_5_)
    {
        super(p_i45458_1_);
    ...
    private boolean func_150532_c(World p_150532_1_, Random p_150532_2_, int p_150532_3_, int p_150532_4_, int p_150532_5_)
    {
        ...
        boolean isSoil = block.canSustainPlant(p_150532_1_, p_150532_3_, p_150532_4_ - 1, p_150532_5_, ForgeDirection.UP, (BlockCocoaSapling)PlantRegistry.cocoasapling);
        ...
        for (int j1 = p_150535_2_ - p_150535_5_; j1 <= p_150535_2_ + p_150535_5_ + 1; ++j1)
        {
            ...
            for (int l1 = p_150535_4_ - p_150535_5_; l1 <= p_150535_4_ + p_150535_5_ + 1; ++l1)
            {
                ...
                if (k1 * k1 + i2 * i2 <= i1 || j2 * j2 + k2 * k2 <= i1 || k1 * k1 + k2 * k2 <= i1 || j2 * j2 + i2 * i2 <= i1)
                {
                    ...
                    {
                        this.setBlockAndNotifyAdequately(p_150535_1_, j1, p_150535_3_, l1, PlantRegistry.oldCocoaLeaf, 0);
                    }
                }
            }
        }
        ...
        for (int j1 = p_150534_2_ - p_150534_5_; j1 <= p_150534_2_ + p_150534_5_; ++j1)
        {
            ...
            for (int l1 = p_150534_4_ - p_150534_5_; l1 <= p_150534_4_ + p_150534_5_; ++l1)
            {
                ...
                if (k1 * k1 + i2 * i2 <= i1)
                {
                    ...
                    {
                        this.setBlockAndNotifyAdequately(p_150534_1_, j1, p_150534_3_, l1, PlantRegistry.oldCocoaLeaf, 0);
                    }
                }
            }
        }
