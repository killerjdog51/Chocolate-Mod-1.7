...
public class WorldGenChocolateSwamp extends WorldGenAbstractTree
{
    private static final String __OBFID = "CL_00000436";

    public WorldGenChocolateSwamp()
    {
        super(false);
    }
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
    {
        ...
        if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256)
        {
                ...
                for (j1 = p_76484_3_ - b0; j1 <= p_76484_3_ + b0 && flag; ++j1)
                {
                    for (k1 = p_76484_5_ - b0; k1 <= p_76484_5_ + b0 && flag; ++k1)
                    {
                        if (i1 >= 0 && i1 < 256)
                        {
                            ...
                            {
                                if (block != LiquidRegistry.chocolateMilkBlock && block != LiquidRegistry.chocolateMilkBlock)
                                {
                                    flag = false;
                                }
            ...
            else
            {
                ...
                boolean isSoil = block1.canSustainPlant(p_76484_1_, p_76484_3_, p_76484_4_ - 1, p_76484_5_, ForgeDirection.UP, (BlockCocoaSapling)PlantRegistry.cocoasapling);
                if (isSoil && p_76484_4_ < 256 - l - 1)
                {
                    ...
                    for (k2 = p_76484_4_ - 3 + l; k2 <= p_76484_4_ + l; ++k2)
                    {
                        ...
                        for (l2 = p_76484_3_ - k1; l2 <= p_76484_3_ + k1; ++l2)
                        {
                            ...
                            for (int i2 = p_76484_5_ - k1; i2 <= p_76484_5_ + k1; ++i2)
                            {
                                ...
                                {
                                    this.func_150515_a(p_76484_1_, l2, k2, i2, PlantRegistry.oldCocoaLeaf);
                                }
                            }
                        }
                    }
                    ...
                    for (k2 = 0; k2 < l; ++k2)
                    {
                        ...
                        if (block2.isAir(p_76484_1_, p_76484_3_, p_76484_4_ + k2, p_76484_5_) || block2.isLeaves(p_76484_1_, p_76484_3_, p_76484_4_ + k2, p_76484_5_) || block2 == LiquidRegistry.chocolateMilkBlock || block2 == LiquidRegistry.chocolateMilkBlock)
                        {
                            this.func_150515_a(p_76484_1_, p_76484_3_, p_76484_4_ + k2, p_76484_5_, PlantRegistry.CocoaLog);
                        }
                    }
    ...
    {
        this.setBlockAndNotifyAdequately(p_76536_1_, p_76536_2_, p_76536_3_, p_76536_4_, PlantRegistry.stringyCaramel, p_76536_5_);
        int i1 = 4;
