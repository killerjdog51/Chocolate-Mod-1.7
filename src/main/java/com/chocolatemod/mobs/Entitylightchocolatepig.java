...
public class Entitylightchocolatepig extends EntityAnimal
{
    /** AI task for player control. */
    private final EntityAIControlledByPlayer aiControlledByPlayer;
    private static final String __OBFID = "CL_00001647";

    public Entitylightchocolatepig(World par1World)
    {
        super(par1World);
    ...
    public Entitylightchocolatepig createChild(EntityAgeable par1EntityAgeable)
    {
        return new Entitylightchocolatepig(this.worldObj);
    }
