...
import com.chocolatemod.worldgen.BiomeGenChocolateBase;
...
public class Entitywhitechocolateglob extends EntityLiving implements IMob
{
    ...
    public Entitywhitechocolateglob(World par1World)
    {
        super(par1World);
    ...
    public void applyEntityAttributes()
    {
     ...
     this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(6.0F);
    }
    ...
    protected void updateEntityActionState()
    {
        ...
        if (this.onGround && this.slimeJumpDelay-- <= 0)
        {
            ...
            this.moveStrafing = 6.0F - this.rand.nextFloat() * 8.0F;
            this.moveForward = (float)(6 * this.getSlimeSize());
        }
        else
        {
    ...
    {
        return this.rand.nextInt(4) + 4;
    }

    protected Entitywhitechocolateglob createInstance()
    {
        return new Entitywhitechocolateglob(this.worldObj);
    }
    ...
    public void setDead()
    {
        ...
        if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
        {
            ...
            for (int k = 0; k < j; ++k)
            {
                ...
                Entitywhitechocolateglob entityslime = this.createInstance();
