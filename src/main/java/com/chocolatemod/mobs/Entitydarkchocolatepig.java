...
public class Entitydarkchocolatepig extends EntityAnimal
{
    /** AI task for player control. */
    private final EntityAIControlledByPlayer aiControlledByPlayer;
    private static final String __OBFID = "CL_00001647";

    public Entitydarkchocolatepig(World par1World)
    {
        super(par1World);
    ...
    public Entitydarkchocolatepig createChild(EntityAgeable par1EntityAgeable)
    {
        return new Entitydarkchocolatepig(this.worldObj);
    }
