...
public class Entitydarkchocolateglob extends EntityLiving implements IMob
{
    ...
    public Entitydarkchocolateglob(World par1World)
    {
        super(par1World);
    ...
    protected void updateEntityActionState()
    {
        ...
        if (this.onGround && this.slimeJumpDelay-- <= 0)
        {
            ...
            this.moveStrafing = 4.0F - this.rand.nextFloat() * 5.0F;
    ...
    {
        return this.rand.nextInt(8) + 7;
    }

    protected Entitydarkchocolateglob createInstance()
    {
        return new Entitydarkchocolateglob(this.worldObj);
    }
    ...
    public void setDead()
    {
        ...
        if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
        {
            ...
            for (int k = 0; k < j; ++k)
            {
                ...
                Entitydarkchocolateglob entityslime = this.createInstance();
