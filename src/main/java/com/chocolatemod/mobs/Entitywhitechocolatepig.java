...
public class Entitywhitechocolatepig extends EntityAnimal
{
    /** AI task for player control. */
    private final EntityAIControlledByPlayer aiControlledByPlayer;
    private static final String __OBFID = "CL_00001647";

    public Entitywhitechocolatepig(World par1World)
    {
        super(par1World);
    ...
    public Entitywhitechocolatepig createChild(EntityAgeable par1EntityAgeable)
    {
        return new Entitywhitechocolatepig(this.worldObj);
    }
