	...
	public boolean interact(EntityPlayer par1EntityPlayer) {
		...
		if (itemstack != null && itemstack.getItem() == Items.bucket && !par1EntityPlayer.capabilities.isCreativeMode) {
			if (itemstack.stackSize-- == 1) {
				par1EntityPlayer.inventory.setInventorySlotContents(par1EntityPlayer.inventory.currentItem, new ItemStack(ItemRegistry.darkchocolatemilk));
			} else if (!par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ItemRegistry.darkchocolatemilk))) {
				par1EntityPlayer.dropPlayerItemWithRandomChoice(new ItemStack(ItemRegistry.darkchocolatemilk, 1, 0), false);
			}
