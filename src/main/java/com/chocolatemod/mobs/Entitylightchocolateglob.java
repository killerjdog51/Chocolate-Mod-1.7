...
public class Entitylightchocolateglob extends EntityLiving implements IMob
{
    ...
    public Entitylightchocolateglob(World par1World)
    {
        super(par1World);
    ...
    public void applyEntityAttributes()
    {
     ...
     this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(4.0F);
    }
    ...
    protected void updateEntityActionState()
    {
        ...
        if (this.onGround && this.slimeJumpDelay-- <= 0)
        {
            ...
            this.moveStrafing = 4.0F - this.rand.nextFloat() * 6.0F;
            this.moveForward = (float)(4 * this.getSlimeSize());
        }
        else
        {
    ...
    protected Entitylightchocolateglob createInstance()
    {
        return new Entitylightchocolateglob(this.worldObj);
    }
    ...
    public void setDead()
    {
        ...
        if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
        {
            ...
            for (int k = 0; k < j; ++k)
            {
                ...
                Entitylightchocolateglob entityslime = this.createInstance();
