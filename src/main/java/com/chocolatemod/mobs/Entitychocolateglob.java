...
public class Entitychocolateglob extends EntityLiving implements IMob
{
    ...
    public Entitychocolateglob(World par1World)
    {
        super(par1World);
    ...
    public void applyEntityAttributes()
    {
     ...
     this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(3.0F);
    }
    /**
    ...
    protected Entitychocolateglob createInstance()
    {
        return new Entitychocolateglob(this.worldObj);
    }
    ...
    public void setDead()
    {
        ...
        if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
        {
            ...
            for (int k = 0; k < j; ++k)
            {
                ...
                Entitychocolateglob entityslime = this.createInstance();
