...
public static final String[] field_94595_b = new String[] {"default_fruit", "dark_fruit", "light_fruit", "white_fruit", "default_nuts", "dark_nuts", "light_nuts", "white_nuts", "default_minty", "dark_minty", "light_minty", "white_minty"};
