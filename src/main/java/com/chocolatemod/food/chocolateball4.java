...
public class chocolateball4 extends ItemFood {

	/**
	 * List of item names
	 */
	public static final String[] itemMetaNames = new String[]{"default.minty.fruit.nuts", "dark.minty.fruit.nuts", "light.minty.fruit.nuts", "white.minty.fruit.nuts"};
	public static final String[] field_94595_b = new String[]{"default_fruit_minty_nuts", "dark_fruit_minty_nuts", "light_fruit_minty_nuts", "white_fruit_minty_nuts"};

	@SideOnly(Side.CLIENT)
	private IIcon[] field_94594_d;

	public chocolateball4(int i, float f, boolean b) {
		super(i, f, b);
