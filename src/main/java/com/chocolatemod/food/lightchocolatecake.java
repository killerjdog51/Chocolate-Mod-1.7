...
public class lightchocolatecake extends Item
{
    ...
    public void registerIcons(IIconRegister iconRegister) {
             this.itemIcon = iconRegister.registerIcon("killerjdog51:lightchocolatecake");}
    /**
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            {
                int i1 = this.spawnID.onBlockPlaced(par3World, par4, par5, par6, par7, par8, par9, par10, 0);

                if (par3World.setBlock(par4, par5, par6, this.spawnID, i1, 3))
                {
                    if (par3World.getBlock(par4, par5, par6) == this.spawnID)
                    {
                        ...
                        this.spawnID.onPostBlockPlaced(par3World, par4, par5, par6, i1);
                    }
