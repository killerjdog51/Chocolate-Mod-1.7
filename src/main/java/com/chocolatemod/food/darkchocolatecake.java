...
public class darkchocolatecake extends Item
{
    ...
    public darkchocolatecake(Block par2Block)
    {
        super();
    ...
    public void registerIcons(IIconRegister iconRegister) {
             this.itemIcon = iconRegister.registerIcon("killerjdog51:darkchocolatecake");}
    /**
