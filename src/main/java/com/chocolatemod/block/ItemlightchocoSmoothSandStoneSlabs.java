...
public class ItemlightchocoSmoothSandStoneSlabs extends ItemBlock {
	...
	public ItemlightchocoSmoothSandStoneSlabs(Block block) {
		super(block);
		this.field_150949_c = BlockRegistry.lightchocoSmoothSandStoneSlabsingle;
		this.field_150947_d = BlockRegistry.lightchocoSmoothSandStoneSlabdouble;
