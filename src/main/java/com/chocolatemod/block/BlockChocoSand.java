...
public class BlockChocoSand extends BlockFalling {
	public static final String[] field_150142_a = new String[]{"white", "dark", "light", "default"};
	public static final String[] field_150141_b = new String[]{"white", "dark", "light", null};
	@SideOnly(Side.CLIENT)
	private IIcon[] field_150143_M;
	private static final String __OBFID = "CL_00000318";

	public BlockChocoSand() {
		super(Material.sand);
