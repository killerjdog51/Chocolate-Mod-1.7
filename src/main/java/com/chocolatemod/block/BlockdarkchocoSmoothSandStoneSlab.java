...
{
public static final String[] woodType = { "killerjdog51:chocolatesandstone_dark_smooth" };
...
{
return BlockRegistry.darkchocoSmoothSandStoneSlabsingle;
}

public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving)
{
if(par1World.getBlock(par2, par3 - 1, par4) == BlockRegistry.darkchocoSmoothSandStoneSlabsingle)
{
par1World.setBlock(par2, par3, par4, null, 0, par4);
par1World.setBlock(par2, par3 - 1, par4, BlockRegistry.darkchocoSmoothSandStoneSlabdouble);
}
if(par1World.getBlock(par2, par3 + 1, par4) == BlockRegistry.darkchocoSmoothSandStoneSlabsingle)
{
par1World.setBlock(par2, par3, par4, null, 0, par4);
...
{
return new ItemStack(BlockRegistry.darkchocoSmoothSandStoneSlabsingle, 2, par1 & 7);
}
...
{
	 if (par1 != BlockRegistry.darkchocoSmoothSandStoneSlabdouble)
	 {
