...
public class ItemSmallChocolateBrickSlabs extends ItemBlock {
	...
	public ItemSmallChocolateBrickSlabs(Block block) {
		super(block);
		this.field_150949_c = BlockRegistry.smallchocolatebricksingle;
		this.field_150947_d = BlockRegistry.smallchocolatebrickdouble;
