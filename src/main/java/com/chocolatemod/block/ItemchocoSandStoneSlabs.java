...
public class ItemchocoSandStoneSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.chocoSandStoneSlabsingle;
    	this.field_150947_d = BlockRegistry.chocoSandStoneSlabdouble;
