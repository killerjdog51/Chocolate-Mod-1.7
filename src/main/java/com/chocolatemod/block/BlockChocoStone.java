...
public class BlockChocoStone extends Block {
	public static final String[] field_150142_a = new String[]{"dark", "default", "light", "white", "dark.cobble", "default.cobble", "light.cobble", "white.cobble", "dark.minty", "default.minty", "light.minty", "white.minty", "dark.caramel", "default.caramel", "light.caramel", "white.caramel"};
	public static final String[] field_150141_b = new String[]{"dark", null, "light", "white", "dark_cobble", "cobble", "light_cobble", "white_cobble", "dark_minty", "minty", "light_minty", "white_minty", "dark_caramel", "caramel", "light_caramel", "white_caramel"};
