...
public class ItemlightchocoCobbleStoneSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.lightchocoCobbleStoneSlabsingle;
    	this.field_150947_d = BlockRegistry.lightchocoCobbleStoneSlabdouble;
