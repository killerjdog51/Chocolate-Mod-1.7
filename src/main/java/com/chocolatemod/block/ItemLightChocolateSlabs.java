...
public class ItemLightChocolateSlabs extends ItemBlock {
	...
	public ItemLightChocolateSlabs(Block block) {
		super(block);
		this.field_150949_c = BlockRegistry.lightchocolatesingle;
		this.field_150947_d = BlockRegistry.lightchocolatedouble;
