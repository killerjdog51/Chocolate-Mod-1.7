...
public class ItemdarkchocoCobbleStoneSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.darkchocoCobbleStoneSlabsingle;
    	this.field_150947_d = BlockRegistry.darkchocoCobbleStoneSlabdouble;
