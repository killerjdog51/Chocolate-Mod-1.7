...
public class ItemchocoCobbleStoneSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.chocoCobbleStoneSlabsingle;
    	this.field_150947_d = BlockRegistry.chocoCobbleStoneSlabdouble;
