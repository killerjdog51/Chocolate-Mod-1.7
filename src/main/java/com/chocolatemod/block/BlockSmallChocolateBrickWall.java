...
public class BlockSmallChocolateBrickWall extends BlockWall {

	public static final String[] field_150142_a = new String[]{"default", "dark", "light", "white"};
	public static final String[] field_150141_b = new String[]{"small", "dark_small", "light_small", "white_small"};
	@SideOnly(Side.CLIENT)
	private IIcon[] field_150143_M;

	private Block icon;

	public BlockSmallChocolateBrickWall(Block block) {
		super(block);
