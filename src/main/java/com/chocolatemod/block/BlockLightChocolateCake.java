...
public class BlockLightChocolateCake extends Block
{
    ...
    protected BlockLightChocolateCake()
    {
        super(Material.cake);
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon("killerjdog51:lightchocolatecake_side");
        this.field_94382_c = p_149651_1_.registerIcon("killerjdog51:chocolatecake_inner");
        this.cakeTopIcon = p_149651_1_.registerIcon("killerjdog51:lightchocolatecake_top");
