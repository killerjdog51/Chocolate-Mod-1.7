...
public class ItemwhitechocoCobbleStoneSlabs extends ItemBlock {
	...
	public ItemwhitechocoCobbleStoneSlabs(Block block) {
		super(block);
		this.field_150949_c = BlockRegistry.whitechocoCobbleStoneSlabsingle;
		this.field_150947_d = BlockRegistry.whitechocoCobbleStoneSlabdouble;
