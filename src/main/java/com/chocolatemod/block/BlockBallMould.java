...
public class BlockBallMould extends Block {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		...
		this.cakeTopIcon = par1IconRegister.registerIcon("killerjdog51:ChocolateBallMould_top");
		this.cakeBottomIcon = par1IconRegister.registerIcon("furnace_top");
	}
