...
public class BlockdarkchocoSandStoneSlab extends BlockSlab {
	public static final String[] woodType = {"killerjdog51:chocolatesandstone_dark_normal"};
	...
	public Block idDropped(int par1, Random par2Random, int par3) {
		return BlockRegistry.darkchocoSandStoneSlabsingle;
	}

	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving) {
		if (par1World.getBlock(par2, par3 - 1, par4) == BlockRegistry.darkchocoSandStoneSlabsingle) {
			par1World.setBlock(par2, par3, par4, null, 0, par4);
			par1World.setBlock(par2, par3 - 1, par4, BlockRegistry.darkchocoSandStoneSlabdouble);
		}
		if (par1World.getBlock(par2, par3 + 1, par4) == BlockRegistry.darkchocoSandStoneSlabsingle) {
			par1World.setBlock(par2, par3, par4, null, 0, par4);
			par1World.setBlock(par2, par3 + 1, par4, BlockRegistry.darkchocoSandStoneSlabdouble);
	...
	protected ItemStack createStackedBlock(int par1) {
		return new ItemStack(BlockRegistry.darkchocoSandStoneSlabsingle, 2, par1 & 7);
	}
	...
	public void getSubBlockRegistry(Block par1, CreativeTabs par2CreativeTabs, List par3List) {
		if (par1 != BlockRegistry.darkchocoSandStoneSlabdouble) {
