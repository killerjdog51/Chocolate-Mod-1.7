...
public class ItemdarkchocoSandStoneSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.darkchocoSandStoneSlabsingle;
    	this.field_150947_d = BlockRegistry.darkchocoSandStoneSlabdouble;
