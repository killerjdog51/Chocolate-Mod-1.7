...
public class ItemSmallWhiteChocolateBrickSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.smallwhitechocolatebricksingle;
    	this.field_150947_d = BlockRegistry.smallwhitechocolatebrickdouble;
