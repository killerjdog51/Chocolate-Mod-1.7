...
public class BlockCocoaDoor extends Block
{
    ...
    protected BlockCocoaDoor(Material p_i45402_1_)
    {
        super(p_i45402_1_);
        float f = 0.5F;
        float f1 = 1.0F;
    ...
    {
        return (p_149650_1_ & 8) != 0 ? null : (this.blockMaterial == Material.iron ? Items.iron_door : ItemRegistry.CocoaDoorItem);
    }
    ...
    {
        return this.blockMaterial == Material.iron ? Items.iron_door : ItemRegistry.CocoaDoorItem;
    }
