...
public class ItemwhitechocoSandStoneSlabs extends ItemBlock {
	...
	public ItemwhitechocoSandStoneSlabs(Block block) {
		super(block);
		this.field_150949_c = BlockRegistry.whitechocoSandStoneSlabsingle;
		this.field_150947_d = BlockRegistry.whitechocoSandStoneSlabdouble;
