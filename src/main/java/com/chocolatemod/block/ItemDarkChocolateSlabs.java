...
public class ItemDarkChocolateSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.darkchocolatesingle;
    	this.field_150947_d = BlockRegistry.darkchocolatedouble;
