...
public class BlockChocolateSlab extends BlockSlab {
	public static final String[] woodType = {"killerjdog51:chocolateslab_side"};
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving) {
		if (par1World.getBlock(par2, par3 - 1, par4) == BlockRegistry.chocolatesingle) {
			par1World.setBlock(par2, par3, par4, null, 0, par4);
			par1World.setBlock(par2, par3 - 1, par4, BlockRegistry.chocolatedouble);
		}
		if (par1World.getBlock(par2, par3 + 1, par4) == BlockRegistry.chocolatesingle) {
			par1World.setBlock(par2, par3, par4, null, 0, par4);
			par1World.setBlock(par2, par3 + 1, par4, BlockRegistry.chocolatedouble);
	...
	protected ItemStack createStackedBlock(int par1) {
		return new ItemStack(BlockRegistry.chocolatesingle, 2, par1 & 7);
	}
	...
	public void getSubBlockRegistry(Block par1, CreativeTabs par2CreativeTabs, List par3List) {
		if (par1 != BlockRegistry.chocolatedouble) {
