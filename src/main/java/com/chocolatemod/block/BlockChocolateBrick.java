...
public class BlockChocolateBrick extends Block {
	public static final String[] field_150142_a = new String[]{"default", "dark", "light", "white", "default.carved", "dark.carved", "light.carved", "whit.carved", "default.small", "dark.small", "light.small", "white.small", "default.fancy", "dark.fancy", "light.fancy", "white.fancy"};
	public static final String[] field_150141_b = new String[]{null, "dark", "light", "white", "carved", "dark_carved", "light_carved", "white_carved", "small", "dark_small", "light_small", "white_small", "fancy", "dark_fancy", "light_fancy", "white_fancy"};
