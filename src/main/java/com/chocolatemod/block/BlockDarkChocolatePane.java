...
public class BlockDarkChocolatePane extends BlockPane
{
   ...
   protected BlockDarkChocolatePane(String p_i45432_1_, String p_i45432_2_, Material p_i45432_3_, boolean p_i45432_4_)
   {
   ...
   {
       return !this.field_150099_b ? BlockRegistry.darkchocolatepane : super.getItemDropped(par1, par2Random, par3);
   }
