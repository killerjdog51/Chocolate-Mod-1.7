...
public class ItemWhiteChocolateSlabs extends ItemBlock {
	...
	public ItemWhiteChocolateSlabs(Block block) {
		super(block);
		this.field_150949_c = BlockRegistry.whitechocolatesingle;
		this.field_150947_d = BlockRegistry.whitechocolatedouble;
