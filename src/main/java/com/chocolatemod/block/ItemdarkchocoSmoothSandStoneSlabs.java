...
public class ItemdarkchocoSmoothSandStoneSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.darkchocoSmoothSandStoneSlabsingle;
    	this.field_150947_d = BlockRegistry.darkchocoSmoothSandStoneSlabdouble;
