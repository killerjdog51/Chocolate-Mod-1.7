...
public class ItemWhiteChocolateBrickSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.whitechocolatebricksingle;
    	this.field_150947_d = BlockRegistry.whitechocolatebrickdouble;
