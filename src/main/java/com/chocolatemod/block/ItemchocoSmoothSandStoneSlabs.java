...
public class ItemchocoSmoothSandStoneSlabs extends ItemBlock {
	...
	public ItemchocoSmoothSandStoneSlabs(Block block) {
		super(block);
		this.field_150949_c = BlockRegistry.chocoSmoothSandStoneSlabsingle;
		this.field_150947_d = BlockRegistry.chocoSmoothSandStoneSlabdouble;
