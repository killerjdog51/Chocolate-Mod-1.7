...
public class BlockFruityChocolateBlock extends Block
{
    public static final String[] field_150142_a = new String[] {"default", "dark", "light", "white", "default.nuts", "dark.nuts", "light.nuts", "white.nuts"};
    public static final String[] field_150141_b = new String[] {null, "dark", "light", "white", "nuts", "dark_nuts", "light_nuts", "white_nuts"};
    @SideOnly(Side.CLIENT)
    private IIcon[] field_150143_M;
    private static final String __OBFID = "CL_00000318";

    public BlockFruityChocolateBlock()
    {
        super(Material.rock);
