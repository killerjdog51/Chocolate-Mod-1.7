...
public class ItemSmallDarkChocolateBrickSlabs extends ItemBlock {
	...
	public ItemSmallDarkChocolateBrickSlabs(Block block) {
		super(block);
		this.field_150949_c = BlockRegistry.smalldarkchocolatebricksingle;
		this.field_150947_d = BlockRegistry.smalldarkchocolatebrickdouble;
