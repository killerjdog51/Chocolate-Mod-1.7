...
public class ItemLightChocolateBrickSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.lightchocolatebricksingle;
    	this.field_150947_d = BlockRegistry.lightchocolatebrickdouble;
