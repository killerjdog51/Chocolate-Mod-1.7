...
public class ItemDarkChocolateBrickSlabs extends ItemBlock {
	...
	public ItemDarkChocolateBrickSlabs(Block block) {
		super(block);
		this.field_150949_c = BlockRegistry.darkchocolatebricksingle;
		this.field_150947_d = BlockRegistry.darkchocolatebrickdouble;
