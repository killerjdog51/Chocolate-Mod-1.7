...
public class ItemSmallLightChocolateBrickSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.smalllightchocolatebricksingle;
    	this.field_150947_d = BlockRegistry.smalllightchocolatebrickdouble;
