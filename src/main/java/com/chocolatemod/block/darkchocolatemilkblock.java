...
public class darkchocolatemilkblock extends BlockFluidClassic {
	...
	public void onBlockAdded(World par1World, int par2, int par3, int par4) {
		...
		if ((par1World.getBlock(par2, par3 - 1, par4) != BlockRegistry.goldchocolateblock) || (!((BlockChocolatePortal) BlockRegistry.BlockChocolatePortal).tryToCreatePortal(par1World, par2, par3, par4))) {
