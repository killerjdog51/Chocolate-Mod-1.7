...
public class ItemlightchocoSandStoneSlabs extends ItemBlock {
	...
	public ItemlightchocoSandStoneSlabs(Block block) {
		super(block);
		this.field_150949_c = BlockRegistry.lightchocoSandStoneSlabsingle;
		this.field_150947_d = BlockRegistry.lightchocoSandStoneSlabdouble;
