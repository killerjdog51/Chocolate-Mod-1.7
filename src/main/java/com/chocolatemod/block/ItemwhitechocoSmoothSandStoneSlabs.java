...
public class ItemwhitechocoSmoothSandStoneSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.whitechocoSmoothSandStoneSlabsingle;
    	this.field_150947_d = BlockRegistry.whitechocoSmoothSandStoneSlabdouble;
