...
public class ItemChocolateBrickSlabs extends ItemBlock
{
    ...
    {
    	super(block);
    	this.field_150949_c = BlockRegistry.chocolatebricksingle;
    	this.field_150947_d = BlockRegistry.chocolatebrickdouble;
