...
import com.chocolatemod.worldgen.WorldGenChocolateTree;
import com.chocolatemod.worldgen.WorldGenCocoaTree;
import com.chocolatemod.worldgen.WorldGenDarkChocolateTree;
import com.chocolatemod.worldgen.WorldGenLightChocolateTree;
import com.chocolatemod.worldgen.WorldGenMegaCocoa;
import com.chocolatemod.worldgen.WorldGenRegistry;
import com.chocolatemod.worldgen.WorldGenWhiteChocolateTree;
...
{
    public static final String[] field_149882_a = new String[] {"cocoa", "chocolate", "dark", "light", "white"};
    ...
    {
        p_149691_2_ &= 7;
        return field_149881_b[MathHelper.clamp_int(p_149691_2_, 0, 4)];
    }
            ...
            case 0:
            	label93:
                    ...
                    for (i1 = 0; i1 >= -1; --i1)
                    {
                        for (j1 = 0; j1 >= -1; --j1)
                        {
                            if (this.func_149880_a(p_149878_1_, p_149878_2_ + i1, p_149878_3_, p_149878_4_ + j1, 0) && this.func_149880_a(p_149878_1_, p_149878_2_ + i1 + 1, p_149878_3_, p_149878_4_ + j1, 0) && this.func_149880_a(p_149878_1_, p_149878_2_ + i1, p_149878_3_, p_149878_4_ + j1 + 1, 0) && this.func_149880_a(p_149878_1_, p_149878_2_ + i1 + 1, p_149878_3_, p_149878_4_ + j1 + 1, 0))
                            {
                                object = new WorldGenMegaCocoa(true, 10, 20, 0, 0);
                                flag = true;
                                break label93;
                            }
                        }
                    ...
                    if (!flag)
                    {
                        j1 = 0;
                        i1 = 0;
                object = new WorldGenCocoaTree(true, 4 + p_149878_5_.nextInt(7), 3, 3, false);
                    }
                break;
            case 1: 
                    object = new WorldGenChocolateTree(true, false);
                break;
            case 2:
                object = new WorldGenDarkChocolateTree(true);
                break;
            case 3:   
                    object = new WorldGenLightChocolateTree(true, false);
                break;
            case 4:
                object = new WorldGenWhiteChocolateTree(true);
                break;
        }
    ...
    {
        return MathHelper.clamp_int(p_149692_1_ & 7, 0, 4);
    }
