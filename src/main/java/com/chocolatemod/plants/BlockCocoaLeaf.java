...
public class BlockCocoaLeaf extends BlockLeavesBase implements IShearable{
	
    int[] field_150128_a;
    protected int field_150127_b;


	protected BlockCocoaLeaf(Material p_i45433_1_, boolean p_i45433_2_) {
	...
	public static final String[][] field_150130_N = new String[][] {{"killerjdog51:leaves_chocolate", "killerjdog51:leaves_dark", "killerjdog51:leaves_light", "killerjdog51:leaves_white"}};
    public static final String[] field_150131_O = new String[] {"chocolate", "dark", "light", "white"};
    ...
    protected void func_150124_c(World p_150124_1_, int p_150124_2_, int p_150124_3_, int p_150124_4_, int p_150124_5_, int p_150124_6_) {
        ...
        {
            this.dropBlockAsItem(p_150124_1_, p_150124_2_, p_150124_3_, p_150124_4_, new ItemStack(FoodRegistry.chocolateapple, 1, 0));
        }
    	else if ((p_150124_5_ & 3) == 1 && p_150124_1_.rand.nextInt(p_150124_6_) == 1)
        {
            this.dropBlockAsItem(p_150124_1_, p_150124_2_, p_150124_3_, p_150124_4_, new ItemStack(FoodRegistry.chocolateapple, 1, 1));
        }
    	else if ((p_150124_5_ & 3) == 2 && p_150124_1_.rand.nextInt(p_150124_6_) == 2)
        {
            this.dropBlockAsItem(p_150124_1_, p_150124_2_, p_150124_3_, p_150124_4_, new ItemStack(FoodRegistry.chocolateapple, 1, 2));
        }
    	else if ((p_150124_5_ & 3) == 3 && p_150124_1_.rand.nextInt(p_150124_6_) == 3)
        {
            this.dropBlockAsItem(p_150124_1_, p_150124_2_, p_150124_3_, p_150124_4_, new ItemStack(FoodRegistry.chocolateapple, 1, 3));
        }
    }
