...
public class bowlMilk extends ItemFood{

	public bowlMilk(int par1, float f, boolean par3) {
		super(par1, par3);
	...
	public void registerIcons(IIconRegister iconRegister) {
	         this.itemIcon = iconRegister.registerIcon("killerjdog51:bowlmilk");}
	    ...
	    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int i, int j, int k, int side, float par8, float par9, float par10)
	    {
	     ...
	     else
	     {
	      ...
	      Block newID = brewing.BlockMilkCauldron;
