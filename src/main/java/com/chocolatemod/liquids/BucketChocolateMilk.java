...
public class BucketChocolateMilk extends ItemBucket {

	public BucketChocolateMilk(Block p_i45331_1_) {
	...
	par2World.setBlock(X, Y, Z, LiquidRegistry.chocolateMilkBlock);

	if(!par3EntityPlayer.capabilities.isCreativeMode) 
	{
	par3EntityPlayer.inventory.consumeInventoryItem(LiquidRegistry.chocolateMilkBucket);
