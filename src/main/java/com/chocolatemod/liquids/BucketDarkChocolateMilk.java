...
public class BucketDarkChocolateMilk extends ItemBucket {

	public BucketDarkChocolateMilk(Block p_i45331_1_) {
	...
	par2World.setBlock(X, Y, Z, LiquidRegistry.darkChocolateMilkBlock);

	if(!par3EntityPlayer.capabilities.isCreativeMode) 
	{
	par3EntityPlayer.inventory.consumeInventoryItem(LiquidRegistry.darkChocolateMilkBucket);
