...
public class BucketLightChocolateMilk extends ItemBucket {

	public BucketLightChocolateMilk(Block p_i45331_1_) {
	...
	par2World.setBlock(X, Y, Z, LiquidRegistry.lightChocolateMilkBlock);

	if(!par3EntityPlayer.capabilities.isCreativeMode) 
	{
	par3EntityPlayer.inventory.consumeInventoryItem(LiquidRegistry.lightChocolateMilkBucket);
