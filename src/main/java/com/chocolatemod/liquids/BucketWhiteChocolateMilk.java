...
public class BucketWhiteChocolateMilk extends ItemBucket {

	public BucketWhiteChocolateMilk(Block p_i45331_1_) {
	...
	par2World.setBlock(X, Y, Z, LiquidRegistry.whiteChocolateMilkBlock);

	if(!par3EntityPlayer.capabilities.isCreativeMode) 
	{
	par3EntityPlayer.inventory.consumeInventoryItem(LiquidRegistry.whiteChocolateMilkBucket);
