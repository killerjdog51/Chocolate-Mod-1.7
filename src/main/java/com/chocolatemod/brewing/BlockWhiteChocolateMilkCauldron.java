...
public class BlockWhiteChocolateMilkCauldron extends Block {
	public static IIcon[] WhiteChocolateCauldronTex;
	public static IIcon[] WhiteChocolateLiquidTex;

	public BlockWhiteChocolateMilkCauldron() {
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister reg) {
		WhiteChocolateCauldronTex = new IIcon[4];
		WhiteChocolateLiquidTex = new IIcon[10];

		WhiteChocolateCauldronTex[0] = reg.registerIcon("cauldron_inner");
		WhiteChocolateCauldronTex[1] = reg.registerIcon("cauldron_top");
		WhiteChocolateCauldronTex[2] = reg.registerIcon("cauldron_bottom");
		WhiteChocolateCauldronTex[3] = reg.registerIcon("cauldron_side");


		WhiteChocolateLiquidTex[0] = reg.registerIcon("killerjdog51:blockMilkCauldronWhiteChocolateMilk");
		WhiteChocolateLiquidTex[1] = reg.registerIcon("killerjdog51:blockWhiteChocolateMilkCauldronChocolateLumpA");
		WhiteChocolateLiquidTex[2] = reg.registerIcon("killerjdog51:blockWhiteChocolateMilkCauldronChocolateLumpB");
		WhiteChocolateLiquidTex[3] = reg.registerIcon("killerjdog51:blockWhiteChocolateMilkCauldronLightChocolateMilk");
		WhiteChocolateLiquidTex[4] = reg.registerIcon("killerjdog51:blockLightChocolateMilkCauldronChocolateLumpA");
		WhiteChocolateLiquidTex[5] = reg.registerIcon("killerjdog51:blockLightChocolateMilkCauldronChocolateLumpB");
		WhiteChocolateLiquidTex[6] = reg.registerIcon("killerjdog51:blockLightChocolateMilkCauldronChocolateMilk");
		WhiteChocolateLiquidTex[7] = reg.registerIcon("killerjdog51:blockChocolateMilkCauldronChocolateLumpA");
		WhiteChocolateLiquidTex[8] = reg.registerIcon("killerjdog51:blockChocolateMilkCauldronChocolateLumpB");
		WhiteChocolateLiquidTex[9] = reg.registerIcon("killerjdog51:blockChocolateMilkCauldronDarkChocolateMilk");
	...
	public IIcon getIcon(int s, int par2) {
		return s == 1 ? WhiteChocolateCauldronTex[1] : (s == 0 ? WhiteChocolateCauldronTex[2] : WhiteChocolateCauldronTex[3]);
	}
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer player, int par6, float par7, float par8, float par9) {
		if (world.isRemote) {
			...
			if (itemstack == null) {
				...
				if (itemstack.getItem() == ItemRegistry.lightchocolatelump) {
