...
public class RenderChocolatebarMould implements ISimpleBlockRenderingHandler
{
        @Override
        ...
        {              
                ...
                IIcon icon1 = BlockChocolateBarMould.ChocolateMouldTex[0];
                renderer.renderFaceYPos(block, (double)i, (double)((float)j - 1.0 + 0.25F), (double)k, icon1);
                renderer.renderFaceYNeg(block, (double)i, (double)((float)j + 1.0F - 0.75F), (double)k, icon1);
 
                int meta = world.getBlockMetadata(i, j, k);
                IIcon icon2 = BlockChocolateBarMould.ChocolateMouldLiquidTex[0];
 
                switch(meta)
                {
                case 0: case 1: case 2: case 3: case 4: icon2 = BlockChocolateBarMould.ChocolateMouldLiquidTex[0]; break;
                case 5: icon2 = BlockChocolateBarMould.ChocolateMouldLiquidTex[1]; break;
